...
export function AudioPlayer({ audioUrl, duration }: AudioPlayerProps) {
  ...
  return (
    <div className="border-b border-gray-200 pb-6 mb-8">
      ...
      <p className="text-xs font-ui text-muted uppercase tracking-wider mb-4">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="flex-1 flex items-center gap-3">
          <span className="text-xs text-muted font-ui w-10 text-right">
          ...
          <span className="text-xs text-muted font-ui w-10">
            {formatTime(duration)}
          </span>
        </div>
        ...
        <button
          ...
          className="px-2 py-1 text-xs font-ui text-muted hover:text-primary transition-colors"
